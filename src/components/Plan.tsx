...
export default function Plan() {
  return (
    <div className="max-w-[1400px] px-4 m-auto py-16 grid lg:grid-cols-2 gap-4 ">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">
          Data can be passed from a parent component to child component using
          Input binding
        </p>
        <p className="pb-6">
          Services act as singletons that can be injected into multiple
          components. They provide a way for components to communicate by
          sharing data and functionality. Components can use services to share
          data or perform actions without direct interaction
        </p>
        <div>
